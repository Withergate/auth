...
public class CredentialsController {
    ...
    public ModelAndView processEmailChange(
            ModelAndView modelAndView,
        ...
        if (success) {
            modelAndView.addObject(SUCCESS_MESSAGE, messages.getMessage("email.changeSuccess", new Object[] {email}, locale));
        } else {
    ...
    public ModelAndView showVerifyEmailPage(
            ModelAndView modelAndView, @RequestParam("token") String token, Locale locale
    ) {
